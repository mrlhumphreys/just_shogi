...
describe JustShogi::OuBase do
  describe '#destinations' do
    it 'returns the squares it can move to if unoccupied' do
      ou_base = JustShogi::OuBase.new(id: 1, player_number: 1)
      from = JustShogi::Square.new(id: '55', x: 4, y: 4, piece: ou_base) 
    ...
    it 'returns the squares it can move to if occupied by opponent' do
      ...
      forward_piece = JustShogi::OuBase.new(id: 2, player_number: 2)
      forward = JustShogi::Square.new(id: '54', x: 4, y: 3, piece: forward_piece) 

      diagonal_forward_piece = JustShogi::OuBase.new(id: 3, player_number: 2)
      diagonal_forward = JustShogi::Square.new(id: '44', x: 5, y: 3, piece: diagonal_forward_piece) 

      side_piece = JustShogi::OuBase.new(id: 4, player_number: 2)
      side = JustShogi::Square.new(id: '45', x: 5, y: 4, piece: side_piece) 

      diagonal_backward_piece = JustShogi::OuBase.new(id: 5, player_number: 2)
      diagonal_backward = JustShogi::Square.new(id: '46', x: 5, y: 5, piece: diagonal_backward_piece) 

      backward_piece = JustShogi::OuBase.new(id: 6, player_number: 2)
    ...
    it 'does not return the squares if they are blocked' do
      ou_base = JustShogi::OuBase.new(id: 1, player_number: 1)
      from = JustShogi::Square.new(id: '55', x: 4, y: 4, piece: ou_base) 
      
      forward_piece = JustShogi::OuBase.new(id: 2, player_number: 1)
      forward = JustShogi::Square.new(id: '54', x: 4, y: 3, piece: forward_piece) 

      diagonal_forward_piece = JustShogi::OuBase.new(id: 3, player_number: 1)
      diagonal_forward = JustShogi::Square.new(id: '44', x: 5, y: 3, piece: diagonal_forward_piece) 

      side_piece = JustShogi::OuBase.new(id: 4, player_number: 1)
      side = JustShogi::Square.new(id: '45', x: 5, y: 4, piece: side_piece) 

      diagonal_backward_piece = JustShogi::OuBase.new(id: 5, player_number: 1)
      diagonal_backward = JustShogi::Square.new(id: '46', x: 5, y: 5, piece: diagonal_backward_piece) 

      backward_piece = JustShogi::OuBase.new(id: 6, player_number: 1)
      backward = JustShogi::Square.new(id: '56', x: 4, y: 5, piece: backward_piece) 
